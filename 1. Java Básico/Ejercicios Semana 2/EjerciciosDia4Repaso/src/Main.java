public class Main {
    public static void main(String[] args) {
        ...
        vectorVerduras[0] = new Verdura(1,"tomate","rojo",55);
        vectorVerduras[1] = new Verdura(2,"lechuga","verde",10);
        vectorVerduras[2] = new Verdura(3,"zanahoria","naranja",30);
        vectorVerduras[3] = new Verdura(4,"berenjena","violeta",25);
        vectorVerduras[4] = new Verdura(5,"espinaca","verde",25);
